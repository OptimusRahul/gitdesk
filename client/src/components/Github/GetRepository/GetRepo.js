...
class GetRepo extends Component {
    ...
    getPageData = (pageNumber) => {
        this.props.fetchRepo(this.props.lastPageNumber, this.props.user, this.props.paginate, pageNumber)
    }
    ...
    render() {  
        ...
        if(this.props.loading){
            ...
            if(!this.props.paginate)
                this.props.user && this.props.fetchRepo(this.props.lastPageNumber, this.props.user, this.props.paginate);
...
const mapDispatchToProps = dispatch => {
    return {
        fetchRepo: (lastPageNumber, user, paginate, page, per_page) => dispatch(actions.fetchOwnerRepo(lastPageNumber, user, paginate, page, per_page))
    };
};
